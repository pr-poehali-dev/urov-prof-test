...
const professions = {
  medical: {
    ...
    icon: 'Heart',
    careers: ['Биоинженер', 'Специалист по ядерной медицине', 'Генетик-консультант', 'Разработчик медицинских технологий'],
    exams: ['Биология', 'Химия', 'Русский язык'],
    description: 'Современная медицина на стыке биологии и технологий',
  },
  it: {
    title: 'Цифровые технологии',
    icon: 'Code',
    careers: ['Специалист по промышленной кибербезопасности', 'Разработчик систем умного производства', 'Инженер по машинному обучению', 'Архитектор IoT-систем'],
    exams: ['Математика', 'Информатика', 'Русский язык'],
    description: 'Цифровизация промышленности и умные технологии для Урала',
  },
  engineering: {
    title: 'Промышленная инженерия',
    icon: 'Cog',
    careers: ['Инженер-робототехник для металлургии', 'Специалист по аддитивным технологиям', 'Инженер по автоматизации производства', 'Проектировщик умных заводов'],
    exams: ['Математика', 'Физика', 'Русский язык'],
    description: 'Модернизация уральской промышленности и Industry 4.0',
  },
};
          ...
          <div className="max-w-3xl mx-auto animate-fade-in">
            <Card>
              ...
              <CardContent className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  <strong>ПрофНавигатор</strong> — это платформа для помощи школьникам Урала в выборе профессий будущего, связанных с развитием региона.
                </p>
                <p>
                  Урал — крупнейший промышленный регион России, где активно развиваются высокие технологии, 
                  модернизируются производства и создаются инновационные решения для индустрии будущего.
                </p>
                <div>
                  <h3 className="font-semibold text-lg mb-2">Направления профессий будущего на Урале:</h3>
                  <ul className="list-disc list-inside space-y-1">
                    <li><strong>Медицинские технологии</strong> — биоинженерия, генетика, ядерная медицина, разработка медицинского оборудования</li>
                    <li><strong>Цифровые технологии</strong> — промышленная кибербезопасность, умное производство, машинное обучение, IoT-системы</li>
                    <li><strong>Промышленная инженерия</strong> — робототехника для металлургии, аддитивные технологии (3D-печать), автоматизация производства, Industry 4.0</li>
                    <li><strong>Нефтегазовые технологии</strong> — цифровизация добычи, экологический мониторинг, инновационное бурение</li>
                    <li><strong>Металлургия нового поколения</strong> — умные заводы, композитные материалы, энергоэффективные технологии</li>
                    <li><strong>Атомная энергетика</strong> — реакторные установки, радиационная безопасность, ядерные технологии</li>
                    <li><strong>Экология и зеленые технологии</strong> — переработка отходов, восстановление почв, экомониторинг</li>
                    <li><strong>Транспортная инженерия</strong> — беспилотный транспорт, умная логистика, железнодорожные технологии</li>
                  </ul>
                </div>
                <p>
                  Наш тест учитывает специфику уральского региона и помогает найти профессию, которая будет востребована 
                  на крупнейших предприятиях Урала: УГМК, Росатом, РЖД, Газпром, НЛМК, ММК и других лидерах индустрии.
                </p>
              </CardContent>
            </Card>
          </div>
