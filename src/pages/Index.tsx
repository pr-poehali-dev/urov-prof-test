...
const questions: Question[] = [
  {
    ...
    options: [
      { value: 'people', label: 'Работа с людьми и помощь им', profession: ['medical', 'social'] },
...
const universities: { [key: string]: University[] } = {
  medical: [
    { name: 'Уральский государственный медицинский университет', city: 'Екатеринбург', specialties: ['Лечебное дело', 'Педиатрия', 'Фармация'] },
    { name: 'Пермский государственный медицинский университет', city: 'Пермь', specialties: ['Лечебное дело', 'Стоматология'] },
    { name: 'Тюменский государственный медицинский университет', city: 'Тюмень', specialties: ['Лечебное дело', 'Медико-профилактическое дело'] },
  ],
  it: [
    { name: 'Уральский федеральный университет (УрФУ)', city: 'Екатеринбург', specialties: ['Программная инженерия', 'Информатика и ВТ', 'Прикладная математика'] },
    { name: 'Пермский национальный исследовательский политехнический университет', city: 'Пермь', specialties: ['Информатика и ВТ', 'Прикладная информатика'] },
    { name: 'Южно-Уральский государственный университет', city: 'Челябинск', specialties: ['Программная инженерия', 'Информационные системы'] },
  ],
  engineering: [
    { name: 'Уральский федеральный университет (УрФУ)', city: 'Екатеринбург', specialties: ['Машиностроение', 'Мехатроника и робототехника', 'Автоматизация'] },
    { name: 'Пермский национальный исследовательский политехнический университет', city: 'Пермь', specialties: ['Машиностроение', 'Технологические машины'] },
    { name: 'Южно-Уральский государственный университет', city: 'Челябинск', specialties: ['Робототехника', 'Мехатроника'] },
  ],
};
